...
class _SearchScreenState extends State<SearchScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return PopScope(
      ...
      child: Scaffold(
        ...
        body: SafeArea(
          child: GetBuilder<Search1Controller>(
            ...
            builder: (controller1) => Column(
              ...
              children: [
                ...
                getVerSpace(30.h),
                buildSearchWidget(context, controller1),
                getVerSpace(19.h),
                if (controller1.searchList.isEmpty)
                  buildNullListWidget()
                else
                  Expanded(
                    flex: 1,
  ...
  Column buildSearchList(Search1Controller controller) {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
  ...
  Widget buildSearchWidget(BuildContext context, Search1Controller controller) {
